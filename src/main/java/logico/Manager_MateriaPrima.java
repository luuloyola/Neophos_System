...
public class Manager_MateriaPrima {
    ...
    public void cargarMateriaPrima(String nombre, String descripcion, String tipo, double precio_unidad, double cant, String nombre) throws Exception{
        MateriaPrima materia_nueva = new MateriaPrima(nombre,descripcion,tipo,precio_unidad);
        daoMatPrima.create_con_id(materia_nueva, nombre);
