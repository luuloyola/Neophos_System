...
public class Consultar_OrdenDeProduccion extends javax.swing.JPanel {
    ...
    private void aceptarButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aceptarButton1ActionPerformed
        ...
        if (tablaInicio1.getSelectedRow()==-1){
            ...
            try {
                ordenCompleta = ManagerOrdenProduccion.getInstance().consultarOrdenDeProduccion(id);
                        
                Set<OrdenProduccion> keys = ordenCompleta.keySet();
                for(OrdenProduccion key : keys){
                    infoOrden = key;
                    System.out.println(infoOrden.toString());
                }
                ...
                for(RenglonProduccion info: infoRenglones){
